    ...
    <CForm>
      <CRow className="g-4 mb-4">
        ...
        <CCol md={12}>
          <CCard>
            <CCardHeader>
              <strong>Gap Analysis Questions</strong>
            </CCardHeader>
            <CCardBody>
              <CRow className="g-4">
                {[
                  {
                    ...
                    text: 'Do you have a dedicated Safety and Health personnel?',
                  },
                  {
                    id: 'q2',
                    title: 'OSH Manuals',
                    text: 'Has your organization established a centralized OSH manuals?',
                  },
                  {
                    id: 'q3',
                    title: 'OSH Policy',
